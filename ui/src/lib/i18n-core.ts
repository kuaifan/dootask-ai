  ...
  zh: {
    ...
    sheet: {
      ...
      models: {
        ...
        thinkingHint: "提示：模型名末尾添加 (thinking) 可启用思考模式，例如：claude-sonnet-4-5 (thinking)",
        cancel: "取消",
        save: "保存",
      },
    },
  ...
  en: {
    ...
    sheet: {
      ...
      models: {
        ...
        thinkingHint: "Tip: append (thinking) to a model name to enable reasoning mode, e.g. claude-sonnet-4-5 (thinking)",
        cancel: "Cancel",
        save: "Save",
      },
    },
